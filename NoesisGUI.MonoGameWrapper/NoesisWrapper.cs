    ...
    public class NoesisWrapper : IDisposable
    {
            ...
            string autoReloadFileFilter = null)
        {
            ...
            else
            {
                ...
                this.View = Noesis.GUI.CreateView(content);
            }
            ...
            this.View.SetTessellationQuality(Noesis.View.TessellationQuality.Medium);
        ...
        private class ContentReloader : IDisposable
        {
            ...
            public ContentReloader(string fullDataPath, string rootXamlRelativePath, string themeResourcesRelativePath, string fileFilter)
            {
                ...
                this.View = this.View = Noesis.GUI.CreateView(this.viewContentControl);
            ...
            private void LoadUI()
            {
                try
                {
                    this.viewContentControl.Content = (Noesis.FrameworkElement)Noesis.GUI.LoadXaml(this.rootXamlRelativePath);
                }
                catch (Exception ex)
                {
